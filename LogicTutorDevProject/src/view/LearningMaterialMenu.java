...
public class LearningMaterialMenu extends GridPane {

	private Button btnExam1;
	private Button btnMenu;


	public LearningMaterialMenu() {
		this.setVgap(15);
		this.setHgap(20);
		...
		btnExam1 = new Button("Example");
		btnMenu = new Button("Menu");

		this.add(btnExam1, 0, 0);
	...
	public void addL1P1Handler(EventHandler<ActionEvent> handler) {
		btnExam1.setOnAction(handler);
	}
